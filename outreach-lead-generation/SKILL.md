...
- **URLs** — full `https://` URLs, never bare handles or domains. If you only have a handle, construct the full URL; if unverified, note it.
- **Phone** — E.164 (`+14155550100`). No spaces, dashes, or parentheses.
